...
###
ds_ref = nc.Dataset('download_ear5_data/data_eval_oct.nc')
...
np.save('../errdata/rmse_u_lin_oct',rmse_u_lin)
np.save('../errdata/rmse_u_nn4_oct',rmse_u_nn4)
np.save('../errdata/rmse_u_nn2_oct',rmse_u_nn2)
np.save('../errdata/rmse_u_nn1_oct',rmse_u_nn1)

np.save('../errdata/rmse_v_lin_oct',rmse_v_lin)
np.save('../errdata/rmse_v_nn4_oct',rmse_v_nn4)
np.save('../errdata/rmse_v_nn2_oct',rmse_v_nn2)
np.save('../errdata/rmse_v_nn1_oct',rmse_v_nn1)

np.save('../errdata/ssim_u_lin_oct',ssim_u_lin)
np.save('../errdata/ssim_u_nn4_oct',ssim_u_nn4)
np.save('../errdata/ssim_u_nn2_oct',ssim_u_nn2)
np.save('../errdata/ssim_u_nn1_oct',ssim_u_nn1)

np.save('../errdata/ssim_v_lin_oct',ssim_v_lin)
np.save('../errdata/ssim_v_nn4_oct',ssim_v_nn4)
np.save('../errdata/ssim_v_nn2_oct',ssim_v_nn2)
np.save('../errdata/ssim_v_nn1_oct',ssim_v_nn1)