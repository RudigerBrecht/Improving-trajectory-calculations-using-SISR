...
###
ds_ref = nc.Dataset('download_ear5_data/data_eval_apr.nc')
...
np.save('../errdata/rmse_u_lin_apr',rmse_u_lin)
np.save('../errdata/rmse_u_nn4_apr',rmse_u_nn4)
np.save('../errdata/rmse_u_nn2_apr',rmse_u_nn2)
np.save('../errdata/rmse_u_nn1_apr',rmse_u_nn1)

np.save('../errdata/rmse_v_lin_apr',rmse_v_lin)
np.save('../errdata/rmse_v_nn4_apr',rmse_v_nn4)
np.save('../errdata/rmse_v_nn2_apr',rmse_v_nn2)
np.save('../errdata/rmse_v_nn1_apr',rmse_v_nn1)

np.save('../errdata/ssim_u_lin_apr',ssim_u_lin)
np.save('../errdata/ssim_u_nn4_apr',ssim_u_nn4)
np.save('../errdata/ssim_u_nn2_apr',ssim_u_nn2)
np.save('../errdata/ssim_u_nn1_apr',ssim_u_nn1)

np.save('../errdata/ssim_v_lin_apr',ssim_v_lin)
np.save('../errdata/ssim_v_nn4_apr',ssim_v_nn4)
np.save('../errdata/ssim_v_nn2_apr',ssim_v_nn2)
np.save('../errdata/ssim_v_nn1_apr',ssim_v_nn1)