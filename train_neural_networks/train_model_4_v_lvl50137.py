...
u_4=np.reshape(np.transpose(u1[:,0:360:8,0:720:8,:], axes=[0, 3, 1,2]),(300*87,45,90,1))
u_2=np.reshape(np.transpose(u1[:,0:360:4,0:720:4,:], axes=[0, 3, 1,2]),(300*87,90,180,1))
...
u_2_val=np.reshape(np.transpose(u1[:,0:360:8,0:720:8,:], axes=[0, 3, 1,2]),(87*10,45,90,1))
u_1_val=np.reshape(np.transpose(u1[:,0:360:4,0:720:4,:], axes=[0, 3, 1,2]),(87*10,90,180,1))
...
##
model.save('../trained_nn_models/model_4_v_lvl50137')
