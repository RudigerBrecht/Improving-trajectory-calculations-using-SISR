...
print('load data')
##
u1 = np.load('../preprocess_data/normalized_train_v_0_50.npy')

u_4=np.reshape(np.transpose(u1[:,0:360:4,0:720:4,:], axes=[0, 3, 1,2]),(300*50,90,180,1))
u_2=np.reshape(np.transpose(u1[:,0:360:2,0:720:2,:], axes=[0, 3, 1,2]),(300*50,180,360,1))
...
u1 = np.load('../preprocess_data/normalized_val_v.npy')[0:50,]
        
u_2_val=np.reshape(np.transpose(u1[:,0:360:4,0:720:4,:], axes=[0, 3, 1,2]),(50*10,90,180,1))
u_1_val=np.reshape(np.transpose(u1[:,0:360:2,0:720:2,:], axes=[0, 3, 1,2]),(50*10,180,360,1))
...
##
model.save('../trained_nn_models/model_2_v_lvl050')
