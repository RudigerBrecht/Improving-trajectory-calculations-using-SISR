...
u_4=np.reshape(np.transpose(u1[:,0:360:2,0:720:2,:], axes=[0, 3, 1,2]),(300*50,180,360,1))
u_2=np.reshape(np.transpose(u1[:,0:360,0:720,:], axes=[0, 3, 1,2]),(300*50,360,720,1))
...
u_2_val=np.reshape(np.transpose(u1[:,0:360:2,0:720:2,:], axes=[0, 3, 1,2]),(50*10,180,360,1))
u_1_val=np.reshape(np.transpose(u1[:,:,:,:], axes=[0, 3, 1,2]),(50*10,360,720,1))
...
##
model.save('../trained_nn_models/model_1_u_lvl050')
