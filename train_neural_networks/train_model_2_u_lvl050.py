...
print('load data')
##
u1 = np.load('../preprocess_data/normalized_train_u_0_50.npy')
...
u1 = np.load('../preprocess_data/normalized_val_u.npy')[0:50,]
...
##
model.save('trained_nn_models/model_2_u_lvl050')
